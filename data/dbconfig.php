...
/*
define('G5_MYSQL_HOST', 'epcs-instance-1.cp5d5juwliuq.ap-northeast-2.rds.amazonaws.com');
define('G5_MYSQL_USER', 'root');
define('G5_MYSQL_PASSWORD', 'super#ingglobal');
*/
define('G5_MYSQL_HOST', '222.232.202.198');
define('G5_MYSQL_USER', 'ingglobal');
define('G5_MYSQL_PASSWORD', 'ingglobal@ingglobal');
define('G5_MYSQL_DB', 'epcs_www');
