...
// 디폴트(실측정): http://icmms.co.kr/device/json/error.php?token=1099de5drf09&mms_idx=1&dta_group=err
// 조건을 바꾸어 보세요.
// http://icmms.co.kr/device/json/error.php?token=1099de5drf09&mms_idx=1&dta_group=err&shf_no=1&dta_code=M0101&dta_item=minute&dta_unit=10&&st_date=2020-04-29&st_time=10:00:00&end_date=2020-04-30&end_time=23:59:59
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
// 디폴트(카운터그룹핑): http://icmms.co.kr/device/json/error.php?token=1099de5drf09&mms_idx=1&dta_group=err&dta_value_type=count
