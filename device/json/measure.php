...
// 디폴트(카운터그룹핑): http://icmms.co.kr/device/json/measure.php?token=1099de5drf09&mms_idx=1&dta_group=mea&dta_value_type=count
// 디폴트(카운터그룹핑): http://localhost/icmms/www/device/json/measure.php?token=1099de5drf09&mms_idx=4&dta_type=3&dta_no=10
...
//	$list = array('');
    ...
    $_REQUEST['dta_type'] = $_REQUEST['dta_type'] ?: 1;
    $_REQUEST['dta_no'] = $_REQUEST['dta_no'] ?: 2;
