...
if ($member['mb_level'] < 3)
    goto_url(G5_BBS_URL."/login.php?url=".urlencode(G5_URL."/device/item_end/form.php"));
    ...
    <div class="tbl_head02 tbl_wrap">
        <table>
            ...
            <tr class="<?php echo $bg.$tr_focus; ?>" orp_idx="<?php echo $row['orp_idx'] ?>" bom_idx="<?=$row['bom_idx']?>">
                ...
                <td class="td_itm_end"><button type="button" oop_idx="<?=$row['oop_idx']?>" class="btn btn_end">종료</button></td>
