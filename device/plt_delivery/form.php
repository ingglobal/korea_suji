...
$plt_btn_type_array = array('out','out','out','cancel');
...
<section>
	<ul>
		<li>출하를 처리하는 API입니다.</li>
		<li>상태코드: 출하처리(out)/출하취소(cancel)</li>
...
<table>
	...
	<tr><td>상태코드</td><td><input type="text" name="plt_btn_type" value="<?=$plt_btn_type_array[rand(0,sizeof($plt_btn_type_array)-1)]?>"></td></tr>
