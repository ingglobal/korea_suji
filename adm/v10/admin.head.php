        ...
        <div id="tnb">
            <ul>
                <?php if($is_admin=='super') { ?>
                    <li class="tnb_li"><a href="<?php echo G5_DEVICE_URL ?>/half_output/form.php" class="tnb_sql">반제품출력</a></li>
                    <li class="tnb_li"><a href="<?php echo G5_DEVICE_URL ?>/half_status/form.php" class="tnb_sql">반제품상태</a></li>
                    <li class="tnb_li"><a href="<?php echo G5_DEVICE_URL ?>/item_output/form.php" class="tnb_sql">완제품출력</a></li>
                    <li class="tnb_li"><a href="<?php echo G5_DEVICE_URL ?>/item_status/form.php" class="tnb_sql">완제품상태</a></li>
