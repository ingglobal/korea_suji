...
<form name="form01" id="form01" action="./order_list2_update.php" onsubmit="return form01_submit(this);" method="post">
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        $s_mod = '<a href="./order_form2.php?'.$qstr.'&amp;w=u&amp;ord_idx='.$row['ord_idx'].'" class="btn btn_03">수정</a>';
...
<div class="btn_fixed_top">
    ...
    <a href="./order_form2.php" id="member_add" class="btn btn_01">추가하기</a>
    <?php } ?>
