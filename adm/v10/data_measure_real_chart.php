...
$(document).on('click','#fsearch button[type=submit]',function(e){
    ...
    var dta_file = (dta_item=='minute'||dta_item=='second') ? '.real' : '.real'; // error.php(그룹핑), error.sum.php(일자이상)
    ...
    var dta_url = '//icmms.co.kr/device/json/measure'+dta_file+'.php?token=1099de5drf09&mms_idx='+mms_idx+'&shf_no='+shf_no+'&dta_type='+dta_type+'&dta_no='+dta_no+'&dta_item='+dta_item+'&dta_unit='+dta_unit+'&st_date='+st_date+'&st_time='+st_time+'&en_date='+en_date+'&en_time='+en_time;
    // console.log(dta_url);
