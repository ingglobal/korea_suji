...
for($i=0;$i<sizeof($fields);$i++) {
    ...
    // 천단위 제거
    if(preg_match("/_price$/",$fields[$i]) || $fields[$i]=='orp_moq' || $fields[$i]=='orp_lead_time')
