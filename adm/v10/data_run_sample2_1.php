...
Highcharts.getJSON(
    'http://icmms.co.kr/device/json/temperature.php?token=1099de5drf09&mms_idx=1&dta_group=mea&dta_type=1&dta_no=0&start_date=2020-04-23&start_time=20:30:00&end_date=2020-04-23&end_time=21:59:59',
    function(data) {
        var seriesOptions = [];
        seriesOptions[0] = {
            name: '온도0',
