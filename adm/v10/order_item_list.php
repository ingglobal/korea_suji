...
$where = array();
$where[] = " bom_status NOT IN ('delete','trash') AND bom.com_idx = '".$_SESSION['ss_com_idx']."' AND bom_type='product' ";   // 디폴트 검색조건
...
$('.btn_select').click(function(e){
    ...
    <?php
    // BOM 구성
    if($file_name=='order_form') {
    ?>
        parent.add_item(bom_idx, bom_name, bom_part_no, com_name, bom_price, bom_price2);
    <?php
    }
    // 게시판 글쓰기
