...
$where = array();
$where[] = " com_level = 2 AND com_idx_par = '{$_SESSION['ss_com_idx']}' AND com_status NOT IN ('trash','delete') AND com_type = 'purchase' ";   // 디폴트 검색조건
...
$g5['title'] = '공급업체 검색'.$total_count_display;
