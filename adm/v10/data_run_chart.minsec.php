...
// data 호출 URL 
$json_url = 'http://icmms.co.kr/device/json/data.php?token=1099de5drf09&mms_idx='.$mms_idx
...
<form id="fsearch" name="fsearch" class="local_sch01 local_sch" method="get">
    ...
    <input type="text" name="st_time" value="<?=$st_time?>" id="st_time" class="frm_input" style="width:45px;">
    ~
    <input type="text" name="en_date" value="<?=$en_date?>" id="en_date" class="frm_input" style="width:80px;">
    <input type="text" name="en_time" value="<?=$en_time?>" id="en_time" class="frm_input" style="width:45px;">
