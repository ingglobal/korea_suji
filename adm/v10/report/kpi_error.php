...
<div id="report_wrapper">
	...
	<div class="div_wrapper">
        <div class="div_left">
            ...
            <!-- ========================================================================================= -->
            <div class="div_title_02f"><i class="fa fa-check" aria-hidden="true"> 구분타입별 비가동</i></div>
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($i >= 0){//($row['item_name'] != 'total'){
                            array_push($err_type_cat,array($row['item_name'].'('.number_format($row['rate'],1).'%)',(int)$row['arm_count_sum']));
                        }
                    }
                    if ($i == 0)
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($row['item_name'] == 'total') {
                            ...
                            $err_faci_tot = (int)$row['arm_count_sum'];
                        }
                        else {
                            $row['tr_class'] = 'tr_stat_normal';
                        }
                        ...
                        $row['rate'] = (float)($row['arm_count_sum'] / $err_faci_tot) * 100; 
                        ...
                        if($i > 0){//($row['item_name'] != 'total'){
                            array_push($err_faci_cat,array($row['item_name'].'('.number_format($row['arm_count_sum']).'회)',(int)$row['rate']));
                        }
                    }
                    if ($i == 0)
                        echo '<tr class="tr_empty"><td class="td_empty" colspan="6">자료가 없습니다.</td></tr>';
            ...
            <div class="div_info_body">
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($i > 0){//($row['item_name'] != 'total'){
                            array_push($err_occur_cat,array($g5['mms'][$row['mms_idx']]['mms_name'].'('.number_format($row['rate'],1).'%)',(int)$row['arm_count_sum']));
                        }
                    }
                    if ($i == 0)
                        echo '<tr class="tr_empty"><td class="td_empty" colspan="6">자료가 없습니다.</td></tr>';
        ...
        <div class="div_right">
            ...
            <!-- ========================================================================================= -->
            <div class="div_title_02f"><i class="fa fa-check" aria-hidden="true"> 일자별 비가동</i></div>
            ...
            <div class="div_info_body">
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($i > 0){//($row['item_name'] != 'total'){
                            array_push($err_day_cat,array($row['item_name'].'('.number_format($row['rate'],1).'%)',(int)$row['arm_predict_sum']));
                        }
                    }
                    if ($i == 0)
                        echo '<tr class="tr_empty"><td class="td_empty" colspan="6">자료가 없습니다.</td></tr>';
            ...
            <div class="div_info_body">
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($i > 0){//($row['item_name'] != 'total'){
                            array_push($err_weekly_cat,array($row['item_name'].'('.number_format($row['rate'],1).'%)',(int)$row['arm_predict_sum']));
                        }
                    }
                    if ($i == 0)
                        echo '<tr class="tr_empty"><td class="td_empty" colspan="6">자료가 없습니다.</td></tr>';
