...
<div id="report_wrapper">
	...
	<div class="div_wrapper">
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($i >= 0){//($row['item_name'] != 'total'){
                            array_push($arm_type_cat,array($row['item_name'].'('.number_format($row['rate'],1).'%)',(int)$row['arm_alarm_sum']));
                        }
                    }
                    if ($i == 0)
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($row['item_name'] == 'total') {
                            ...
                            $arm_faci_tot = (int)$row['arm_alarm_sum'];
                        }
                        else {
                            $row['tr_class'] = 'tr_stat_normal';
                        }
                        ...
                        $row['rate'] = (float)($row['arm_alarm_sum'] / $arm_faci_tot) * 100; 
                        ...
                        if($i > 0){//($row['item_name'] != 'total'){
                            array_push($arm_faci_cat,array($row['item_name'].'('.(int)$row['arm_alarm_sum'].'회)',$row['rate']));
                        }
                    }
                    if ($i == 0)
                        echo '<tr class="tr_empty"><td class="td_empty" colspan="6">자료가 없습니다.</td></tr>';
            ...
            <div class="div_info_body">
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($i > 0){//($row['item_name'] != 'total'){
                            array_push($arm_occur_cat,array($row['item_name'].'('.number_format($row['rate'],1).'%)',$row['arm_count_sum']));
                        }
                    }
                    if ($i == 0)
                        echo '<tr class="tr_empty"><td class="td_empty" colspan="6">자료가 없습니다.</td></tr>';
        ...
        <div class="div_right">
            ...
            <!-- ========================================================================================= -->
            <div class="div_title_02f"><i class="fa fa-check" aria-hidden="true"> 일자별 알람</i></div>
            ...
            <div class="div_info_body">
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($i > 0){//($row['item_name'] != 'total'){
                            array_push($arm_day_cat,array($row['item_name'].'('.number_format($row['rate'],1).'%)',(int)$row['arm_alarm_sum']));
                        }
                    }
                    if ($i > 0)
                        echo '<tr class="tr_empty"><td class="td_empty" colspan="6">자료가 없습니다.</td></tr>';
            ...
            <div class="div_info_body">
                ...
                <table class="table01">
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        if($i > 0){//($row['item_name'] != 'total'){
                            array_push($arm_weekly_cat,array($row['item_name'].'('.number_format($row['rate'],1).'%)',(int)$row['arm_alarm_sum']));
                        }
                    }
                    if ($i == 0)
                        echo '<tr class="tr_empty"><td class="td_empty" colspan="6">자료가 없습니다.</td></tr>';
