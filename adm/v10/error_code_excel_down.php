...
// 각 항목 설정
$headers = array('고유번호','업체번호','IMP번호','MMS번호','코드','분류','비가동영향','품질영향','그룹(pre=PLC예지)','타입(r,a,p,p2)','주기시간(초)','횟수','하루최대','내용','메모(알림내용)');
$widths  = array(10,      10,      10,     10,       10,   10,  10,        10,     15,               15,             13,          6,    10,     40,    60);
